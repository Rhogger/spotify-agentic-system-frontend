...
// Base dropdown configuration for consistent styling
// - Elevated background (surface-elevated)
// - Subtle border
// - Muted text defaults with hover highlights
export const baseDropdown: Pick<DropdownMenuProps, 'content' | 'ui'> = {
  ...
  ui: {
    content:
      'bg-surface-elevated border border-white/10 p-1 min-w-48 shadow-xl rounded-md',
